        ...
        <div className="bg-slate-900/90 backdrop-blur-xl border border-slate-800 py-8 px-6 sm:px-10 rounded-3xl shadow-2xl shadow-black/80 space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-semibold text-slate-300 mb-1.5">
                Phone Number or Email (Login ID):
              </label>
              <div className="relative">
                ...
                <input
                  type="text"
                  required
                  placeholder="e.g. 7874492405 or vivekbhalani74@gmail.com"
                  value={phone}
          ...
          <div className="pt-4 border-t border-slate-800/80 space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                type="button"
                onClick={() => handleQuickLogin('7874492405', 'admin123')}
              ...
              >
                <div className="flex items-center gap-1.5 text-white font-bold text-xs group-hover:text-sky-400">
                  ...
                  <span>Boss / Vivek</span>
                </div>
                <div className="text-[10px] text-slate-500 font-mono mt-0.5">7874492405</div>
              </button>
